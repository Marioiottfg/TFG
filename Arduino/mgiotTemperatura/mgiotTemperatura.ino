...
const char *ssid = "mgiotTemperatura";

ESP8266WebServer server(80);

// Funcion que atiende las peticiones del servidor de la Raspberry Pi
void devolverTemperatura(){
  // Lectura del valor de temperatura del nodo
...
void setup() {
  ...
  server.on("/getData", devolverTemperatura);
  server.begin();
